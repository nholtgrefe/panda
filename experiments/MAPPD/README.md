# Supplementary data and scripts (PaNDA paper)
...
The results in the paper and in this folder were all obtained using version `1.0.1` of `phypanda`. To install this exact version, run `pip install phypanda==1.0.1`.
