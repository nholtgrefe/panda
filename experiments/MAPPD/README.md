# Supplementary data and scripts (PaNDA — MAPPD experiments)

Budgeted phylogenetic diversity timings and benchmarks (MAPD / max-tree / min-tree on contracted networks) live in **[`../budgeted_PD/`](../budgeted_PD/)** (sibling folder under `experiments/`).
...
The results in the paper and in this repository were all obtained using version `1.0.1` of `phypanda`. To install this exact version, run `pip install phypanda==1.0.1`.
